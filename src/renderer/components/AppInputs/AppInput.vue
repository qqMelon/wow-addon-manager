...
<template>
  <div class="app-input-container mr-2">
    <label for="email-address-icon" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">{{ props.label }}</label>
    <div class="relative">
